...
datadir = "/home/jsm99/data/model_test/sigma/" # need to change this for every run!
...
data = jsm_mcmc.init_data(fid_theta, "/home/jsm99/data/model_test/mock_data.npy")
...
test = jsm_mcmc.inspect_run(mcmc_out, data=data, forward=forward, start_theta=start_theta,
                            labels=params, priors=priors, savedir=datadir, min_mass=min_mass, a_stretch=a_stretch, SHMR_model="sigma")