...
chain_name = "model_1000/"
savedir = parentdir+"model_runs/survey/Nsample/"+chain_name
...
data = jsm_models.init_data(fid_theta, parentdir+"model_runs/survey/Nsample/"+chain_name+"mock_data.npy")
