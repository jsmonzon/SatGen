...
def lnlike(theta):
    ...
    lnL_KS_sec = jsm_stats.lnL_KS_sec(data, models)
    lnL_KS_thir = jsm_stats.lnL_KS_thir(data, models)
    lnL = lnL_Pnsat + lnL_KS_max + lnL_KS_sec + lnL_KS_thir
    return lnL, lnL_Pnsat, lnL_KS_thir
...
dtype = [("lnL_N", float), ("lnL_Msthir", float)]
