...
print("intializing the sigmagrow run")
...
# datadir = "/home/jsm99/data/model_complexity/sigma_grow/" # need to change this for every run!

massdir = "../../../data/MW-analog/meta_data_psi3/"
datadir = "../../../data/paper/model_complexity/sigma_grow/"
...
def forward(theta):
    models.convert(theta, jsm_SHMR.sigma_grow) # need to change this for every run!
