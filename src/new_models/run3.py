...
# datadir = "/home/jsm99/data/model_complexity/redshift/" # need to change this for every run!

massdir = "../../../data/MW-analog/meta_data_psi3/"
datadir = "../../../data/paper/model_complexity/redshift/"
...
models = jsm_mcmc_general.load_models(massdir, read_red=True) # need to change this for every run!
