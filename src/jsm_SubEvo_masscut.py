...
#
# Modified from jsm_SubEvo.py to evolve only ONE host-mass bin out of a
# datadir containing the full sampled mass spectrum, instead of every
# tree in it. Tree files are named "tree_{mass}_{idx}.npz" (e.g.
...
# to 1 decimal, e.g. 13.0 -> "13.0"). Set to None to evolve every mass in
# datadir, same as the original jsm_SubEvo.py.
target_logM = 13.0
